...
namespace SA.Accounting.Infrastructure.Presistance.Migrations
{
    ...
    [Migration("20260804175722_add_null_to_ssn_application_user")]
    partial class add_null_to_ssn_application_user
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SA.Accounting.Core.Entities.Attachments.Attachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("Attachments", t =>
                        {
                            t.HasCheckConstraint("CK_Attachment_FileName_NotEmpty", "LEN(LTRIM(RTRIM([FileName]))) > 0");

                            t.HasCheckConstraint("CK_Attachment_StoredFileName_NotEmpty", "LEN(LTRIM(RTRIM([StoredFileName]))) > 0");
                        });
                });
            ...
            modelBuilder.Entity("SA.Accounting.Core.Entities.Custodies.CustodyMovement", b =>
                {
                    ...
                    b.HasIndex("ExpenseClaimId")
                        .IsUnique()
                        .HasFilter("[ExpenseClaimId] IS NOT NULL");
            ...
            modelBuilder.Entity("SA.Accounting.Core.Entities.Custodies.CustodyMovement", b =>
                {
                    ...
                    b.HasOne("SA.Accounting.Core.Entities.ExpenseClaims.ExpenseClaim", "ExpenseClaim")
                        .WithOne("SettlementMovement")
                        .HasForeignKey("SA.Accounting.Core.Entities.Custodies.CustodyMovement", "ExpenseClaimId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("SA.Accounting.Core.Entities.ExpenseClaims.ExpenseClaim", b =>
                {
                    ...
                    b.Navigation("SettlementMovement");
                });
